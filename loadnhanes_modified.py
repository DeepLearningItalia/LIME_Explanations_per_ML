...
def _load(biochemtapepath="data/nhanes_data/DU4800.txt", medexamtapepath='data/nhanes_data/DU4233.txt',
         anthropometrypath="data/nhanes_data/DU4111.txt", vitlpath="data/nhanes_data/N92vitl.txt"):
    '''
    ...
    with open(biochemtapepath, 'r') as handle:
        for line in handle:
            ...
            if d[seqn]['physical_activity'] == 8:
                d[seqn]['physical_activity'] = numpy.nan
    ...
    #             d[seqn]['serum_albumin_isBlank'] = True
            ...
            if d[seqn]['alkaline_phosphatase'] in [7777,8888,9999]:
                d[seqn]['alkaline_phosphatase'] = numpy.nan
                d[seqn]['alkaline_phosphatase_blank_or_unacceptable'] = True
            else:
                d[seqn]['alkaline_phosphatase_blank_or_unacceptable'] = False
            ...
            if d[seqn]['SGOT'] in [7777,8888,9999]:
                d[seqn]['SGOT'] = numpy.nan
                d[seqn]['SGOT_blank_or_unacceptable'] = True
            else:
                d[seqn]['SGOT_blank_or_unacceptable'] = False
            d[seqn]['SGOT'] /= 100
            ...
            if d[seqn]['BUN'] in [777,999]:
                d[seqn]['BUN'] = numpy.nan
                d[seqn]['BUN_blank_or_unacceptable'] = True
            else:
                d[seqn]['BUN_blank_or_unacceptable'] = False
            d[seqn]['BUN'] /= 10
            ...
            if d[seqn]['calcium'] in [777,888,999]:
                d[seqn]['calcium'] = numpy.nan
                d[seqn]['calcium_blank_or_unacceptable'] = True
            else:
                d[seqn]['calcium_blank_or_unacceptable'] = False
            d[seqn]['calcium'] /= 10
            ...
            if d[seqn]['creatinine'] in [777,888,999]:
                d[seqn]['creatinine'] = numpy.nan
                d[seqn]['creatinine_blank_or_unacceptable'] = True
            else:
                d[seqn]['creatinine_blank_or_unacceptable'] = False
            ...
            if d[seqn]['potassium'] in [777,888,999]:
                d[seqn]['potassium'] = numpy.nan
                d[seqn]['potassium_blank_or_unacceptable'] = True
            else:
                d[seqn]['potassium_blank_or_unacceptable'] = False
            d[seqn]['potassium'] /= 10
            ...
            if d[seqn]['sodium'] in [777,888,999]:
                d[seqn]['sodium'] = numpy.nan
                d[seqn]['sodium_blank_or_unacceptable'] = True
            else:
                d[seqn]['sodium_blank_or_unacceptable'] = False
            ...
            if d[seqn]['total_bilirubin'] in [7777,8888,9999]:
                d[seqn]['total_bilirubin'] = numpy.nan
                d[seqn]['total_bilirubin_blank_or_unacceptable'] = True
            else:
                d[seqn]['total_bilirubin_blank_or_unacceptable'] = False
            ...
            if d[seqn]['serum_protein'] in [7777,8888,9999]:
                d[seqn]['serum_protein'] = numpy.nan
                d[seqn]['serum_protein_blank_or_unacceptable'] = True
            else:
                d[seqn]['serum_protein_blank_or_unacceptable'] = False
    ...
    #             d[seqn]['serum_protein_isBlank'] = True
            ...
            if d[seqn]['red_blood_cells'] in [777,888,9999]:
                d[seqn]['red_blood_cells'] = numpy.nan
                d[seqn]['red_blood_cells_blank_or_unacceptable'] = True
            else:
                d[seqn]['red_blood_cells_blank_or_unacceptable'] = False
            ...
            if d[seqn]['white_blood_cells'] in [777,888,9999]:
                d[seqn]['white_blood_cells'] = numpy.nan
                d[seqn]['white_blood_cells_blank_or_unacceptable'] = True
            else:
                d[seqn]['white_blood_cells_blank_or_unacceptable'] = False
            ...
            if d[seqn]['hemoglobin'] in [7777,8888,9999]:
                d[seqn]['hemoglobin'] = numpy.nan
                d[seqn]['hemoglobin_blank_or_unacceptable'] = True
            else:
                d[seqn]['hemoglobin_blank_or_unacceptable'] = False
    ...
    #             d[seqn]['hemoglobin_isBlank'] = True
            ...
            if d[seqn]['hematocrit'] in [777,888,9999]:
                d[seqn]['hematocrit'] = numpy.nan
                d[seqn]['hematocrit_blank_or_unacceptable'] = True
            else:
                d[seqn]['hematocrit_blank_or_unacceptable'] = False
    #         try:
    ...
    #         d[seqn]['platelets_isNoestimate'] = (platelets == 9)           
            ...
            if platelets == 9:
                d[seqn]["platelets"] = numpy.nan
                d[seqn]['platelets_isBlank'] = True
            ...
            if d[seqn]['cholesterol'] in [777,888,9999]:
                d[seqn]['cholesterol'] = numpy.nan
                d[seqn]['cholesterol_blank_or_unacceptable'] = True
            else:
                d[seqn]['cholesterol_blank_or_unacceptable'] = False
    #         try:
    ...
    #         d[seqn]['urine_albumin_isTrace'] = (urine_albumin == 5)
            d[seqn]['urine_albumin'] = urine_albumin
            d[seqn]['urine_albumin_isBlank'] = numpy.isnan(urine_albumin) 

            if urine_albumin == 8:
                d[seqn]['urine_albumin_isBlank'] = True 
                d[seqn]['urine_albumin'] = numpy.nan
    ...
    #         d[seqn]['urine_glucose_isTrace'] = (urine_glucose == 5)
            d[seqn]['urine_glucose'] = urine_glucose
            d[seqn]['urine_glucose_isBlank'] = numpy.isnan(urine_glucose) 

            if urine_glucose == 8:
                d[seqn]['urine_glucose_isBlank'] = True 
                d[seqn]['urine_glucose'] = numpy.nan
    ...
    #         d[seqn]['urine_hematest_isBlank'] = numpy.isnan(urine_hematest)
            ...
            d[seqn]['urine_hematest'] = urine_hematest
            d[seqn]['urine_hematest_isBlank'] = numpy.isnan(urine_hematest) 
            if urine_hematest == 8:
                d[seqn]['urine_hematest_isBlank'] = True 
                d[seqn]['urine_hematest'] = numpy.nan
            ...
            if d[seqn]['sedimentation_rate'] in [777,888,9999]:
                d[seqn]['sedimentation_rate'] = numpy.nan
                d[seqn]['sedimentation_rate_blank_or_unacceptable'] = True
            else:
                d[seqn]['sedimentation_rate_blank_or_unacceptable'] = False
            ...
            if d[seqn]['uric_acid'] in [777,888,999]:
                d[seqn]['uric_acid'] = numpy.nan
                d[seqn]['uric_acid_blank_or_unacceptable'] = True
            else:
                d[seqn]['uric_acid_blank_or_unacceptable'] = False
    ...
    with open(medexamtapepath, 'r') as handle:
        for line in handle:
            ...
            if d[seqn]['systolic_blood_pressure'] in [777,888,999]:
                d[seqn]['systolic_blood_pressure'] = numpy.nan
                d[seqn]['systolic_blood_pressure_blank'] = True
            else:
                d[seqn]['systolic_blood_pressure_blank'] = False
